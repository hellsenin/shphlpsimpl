    ...
    <div id="content">
       ...
       <!-- Main-->
        <div id="main">
            ...
            <%@ include file="/WEB-INF/jsp/template/messages.jsp"%> 
            <decorator:body /><!-- ContentMain -->
            <div id="underground"><decorator:getProperty property="page.underground" /></div>
        </div>
       <!-- Sub-->
       <div id="sub">
            <%@ include file="/WEB-INF/jsp/template/account.jsp"%>
            <%@ include file="/WEB-INF/jsp/template/banner.jsp"%>
       </div>
    </div>
    <!-- end content -->
