package shophelp.co.kr.cmmsystem.main.web;
...
public class MainController implements ApplicationContextAware ,InitializingBean {
	...
	public String top(){
		return "shophelp/co/kr/cmm/frame/unittop";
	}

	@RequestMapping("/Bottom.do")
	public String bottom(){
		return "shophelp/co/kr/cmm/frame/unitbottom";
	}
	...
	public String setContent(ModelMap model){
		...
		return "shophelp/co/kr/cmm/frame/unitcontent";
	}
	...
	public String setLeftMenu(ModelMap model){
		...
		return "shophelp/co/kr/cmm/frame/unitleft";
	}
}
